#!/usr/bin/env python3
"""Self-contained nv_small NVDLA replay for b1_c192_h28_w28_oc32 1x1 CONV.

The descriptors and weights are embedded or generated from:
ref/onnc-tutorial/models/conv2d_b1_c192_h28_w28_oc32_wic192_k1x1_g1/out_nv_small.nvdla
"""
import ctypes
import glob
import math
...
WEIGHT_ROW_STARTS = (
    0, 16, 15, 14, 5, 4, 3, 2, 10, 9, 8, 7, 15, 14, 13, 12, 3, 2, 1, 0, 8, 7, 6, 5,
    13, 12, 11, 10, 1, 0, 16, 15, 6, 5, 4, 3, 11, 10, 9, 8, 16, 15, 14, 13, 4, 3, 2, 1,
    9, 8, 7, 6, 14, 13, 12, 11, 2, 1, 0, 16, 7, 6, 5, 4, 13, 12, 11, 10, 1, 0, 16, 15,
    6, 5, 4, 3, 11, 10, 9, 8, 16, 15, 14, 13, 4, 3, 2, 1, 9, 8, 7, 6, 14, 13, 12, 11,
    2, 1, 0, 16, 7, 6, 5, 4, 12, 11, 10, 9, 0, 16, 15, 14, 5, 4, 3, 2, 10, 9, 8, 7,
    15, 14, 13, 12, 3, 2, 1, 0, 9, 8, 7, 6, 14, 13, 12, 11, 2, 1, 0, 16, 7, 6, 5, 4,
    12, 11, 10, 9, 0, 16, 15, 14, 5, 4, 3, 2, 10, 9, 8, 7, 15, 14, 13, 12, 3, 2, 1, 0,
    8, 7, 6, 5, 13, 12, 11, 10, 1, 0, 16, 15, 6, 5, 4, 3, 11, 10, 9, 8, 16, 15, 14, 13,
    12, 11, 10, 9, 0, 16, 15, 14, 5, 4, 3, 2, 10, 9, 8, 7, 15, 14, 13, 12, 3, 2, 1, 0,
    8, 7, 6, 5, 13, 12, 11, 10, 1, 0, 16, 15, 6, 5, 4, 3, 11, 10, 9, 8, 16, 15, 14, 13,
    4, 3, 2, 1, 9, 8, 7, 6, 14, 13, 12, 11, 2, 1, 0, 16, 8, 7, 6, 5, 13, 12, 11, 10,
    1, 0, 16, 15, 6, 5, 4, 3, 11, 10, 9, 8, 16, 15, 14, 13, 4, 3, 2, 1, 9, 8, 7, 6,
    14, 13, 12, 11, 2, 1, 0, 16, 7, 6, 5, 4, 12, 11, 10, 9, 0, 16, 15, 14, 5, 4, 3, 2,
    10, 9, 8, 7, 15, 14, 13, 12, 4, 3, 2, 1, 9, 8, 7, 6, 14, 13, 12, 11, 2, 1, 0, 16,
    7, 6, 5, 4, 12, 11, 10, 9, 0, 16, 15, 14, 5, 4, 3, 2, 10, 9, 8, 7, 15, 14, 13, 12,
    3, 2, 1, 0, 8, 7, 6, 5, 13, 12, 11, 10, 1, 0, 16, 15, 6, 5, 4, 3, 11, 10, 9, 8,
)
...
assert (INPUT_BYTES, OUTPUT_BYTES) == (301056, 50176)
