...
static const struct dla_reg program_initial[] = {
    ...
    { 0x9018, 0x9fdfedbd }, /* NVDLA_SDP_S_LUT_LE_START_0 */
    ...
    { 0x90a4, 0x000070ff }, /* NVDLA_SDP_D_DP_EW_MUL_CVT_SCALE_VALUE_0 */
    { 0x90a8, 0x00000019 }, /* NVDLA_SDP_D_DP_EW_MUL_CVT_TRUNCATE_VALUE_0 */
    { 0x90f4, 0x00000000 }, /* NVDLA_SDP_D_PERF_LUT_LE_HIT_0 */
    { 0x901c, 0xa7dfedbd }, /* NVDLA_SDP_S_LUT_LE_END_0 */
    ...
    { 0x9064, 0x00003500 }, /* NVDLA_SDP_D_DP_BS_MUL_CFG_0 */
    ...
    { 0x9078, 0x00000100 }, /* NVDLA_SDP_D_DP_BN_MUL_CFG_0 */
    { 0x90ac, 0x0000001a }, /* NVDLA_SDP_D_DP_EW_TRUNCATE_VALUE_0 */
    ...
    { 0x9060, 0xee0fe1cf }, /* NVDLA_SDP_D_DP_BS_ALU_SRC_VALUE_0 */
    { 0x90d8, 0x00000000 }, /* NVDLA_SDP_D_STATUS_NAN_OUTPUT_NUM_0 */
    { 0x9068, 0x0000ed97 }, /* NVDLA_SDP_D_DP_BS_MUL_SRC_VALUE_0 */
    { 0x90a0, 0xb3754447 }, /* NVDLA_SDP_D_DP_EW_MUL_CVT_OFFSET_VALUE_0 */
    { 0x9094, 0x000003d5 }, /* NVDLA_SDP_D_DP_EW_ALU_CVT_TRUNCATE_VALUE_0 */
    { 0x909c, 0x000053b1 }, /* NVDLA_SDP_D_DP_EW_MUL_SRC_VALUE_0 */
    { 0x906c, 0x00000002 }, /* NVDLA_SDP_D_DP_BN_CFG_0 */
    { 0x9098, 0x00000002 }, /* NVDLA_SDP_D_DP_EW_MUL_CFG_0 */
    { 0x9070, 0x00000100 }, /* NVDLA_SDP_D_DP_BN_ALU_CFG_0 */
    { 0x90f8, 0x00000000 }, /* NVDLA_SDP_D_PERF_LUT_LO_HIT_0 */
    { 0x908c, 0x8b0f5904 }, /* NVDLA_SDP_D_DP_EW_ALU_CVT_OFFSET_VALUE_0 */
    { 0x90d4, 0x00000000 }, /* NVDLA_SDP_D_STATUS_INF_INPUT_NUM_0 */
    { 0x9090, 0x0000ce5d }, /* NVDLA_SDP_D_DP_EW_ALU_CVT_SCALE_VALUE_0 */
    { 0x9080, 0x00000073 }, /* NVDLA_SDP_D_DP_EW_CFG_0 */
    { 0x9088, 0x81df8fd3 }, /* NVDLA_SDP_D_DP_EW_ALU_SRC_VALUE_0 */
    { 0x903c, 0x00000002 }, /* NVDLA_SDP_D_DATA_CUBE_WIDTH_0 */
    { 0x9010, 0x00000021 }, /* NVDLA_SDP_S_LUT_CFG_0 */
    { 0x9014, 0x00171508 }, /* NVDLA_SDP_S_LUT_INFO_0 */
    { 0x9020, 0x8cd7e128 }, /* NVDLA_SDP_S_LUT_LO_START_0 */
    { 0x9024, 0x0cd7e128 }, /* NVDLA_SDP_S_LUT_LO_END_0 */
    { 0x9028, 0x3975e189 }, /* NVDLA_SDP_S_LUT_LE_SLOPE_SCALE_0 */
    { 0x902c, 0x000000c1 }, /* NVDLA_SDP_S_LUT_LE_SLOPE_SHIFT_0 */
    { 0x9030, 0xe40e1680 }, /* NVDLA_SDP_S_LUT_LO_SLOPE_SCALE_0 */
    { 0x9034, 0x000000ad }, /* NVDLA_SDP_S_LUT_LO_SLOPE_SHIFT_0 */
    { 0x8004, 0x00000000 }, /* NVDLA_SDP_RDMA_S_POINTER_0 */
    { 0x8038, 0x00028500 }, /* NVDLA_SDP_RDMA_D_BS_SURFACE_STRIDE_0 */
    { 0x8068, 0x00000020 }, /* NVDLA_SDP_RDMA_D_EW_SURFACE_STRIDE_0 */
    { 0x800c, 0x00000002 }, /* NVDLA_SDP_RDMA_D_DATA_CUBE_WIDTH_0 */
    { 0x802c, 0x1e897aa0 }, /* NVDLA_SDP_RDMA_D_BS_BASE_ADDR_LOW_0 */
    { 0x8054, 0x643e1720 }, /* NVDLA_SDP_RDMA_D_BN_BATCH_STRIDE_0 */
    { 0x801c, 0x00000000 }, /* NVDLA_SDP_RDMA_D_SRC_BASE_ADDR_HIGH_0 */
    { 0x8018, 0xc0000100 }, /* NVDLA_SDP_RDMA_D_SRC_BASE_ADDR_LOW_0 */
    { 0x8044, 0x029eb8c0 }, /* NVDLA_SDP_RDMA_D_BN_BASE_ADDR_LOW_0 */
    { 0x8060, 0x00000054 }, /* NVDLA_SDP_RDMA_D_EW_BASE_ADDR_HIGH_0 */
    { 0x8040, 0x00000005 }, /* NVDLA_SDP_RDMA_D_NRDMA_CFG_0 */
    { 0x8020, 0x00000040 }, /* NVDLA_SDP_RDMA_D_SRC_LINE_STRIDE_0 */
    { 0x8034, 0x00002040 }, /* NVDLA_SDP_RDMA_D_BS_LINE_STRIDE_0 */
    ...
    { 0x805c, 0x1b440320 }, /* NVDLA_SDP_RDMA_D_EW_BASE_ADDR_LOW_0 */
    { 0x8074, 0x00000001 }, /* NVDLA_SDP_RDMA_D_SRC_DMA_CFG_0 */
    { 0x8088, 0x00000000 }, /* NVDLA_SDP_RDMA_D_PERF_BRDMA_READ_STALL_0 */
    { 0x8048, 0x000000ce }, /* NVDLA_SDP_RDMA_D_BN_BASE_ADDR_HIGH_0 */
    { 0x8028, 0x00000019 }, /* NVDLA_SDP_RDMA_D_BRDMA_CFG_0 */
    { 0x808c, 0x00000000 }, /* NVDLA_SDP_RDMA_D_PERF_NRDMA_READ_STALL_0 */
    { 0x8030, 0x0000002b }, /* NVDLA_SDP_RDMA_D_BS_BASE_ADDR_HIGH_0 */
    ...
    { 0x806c, 0x1cc41020 }, /* NVDLA_SDP_RDMA_D_EW_BATCH_STRIDE_0 */
    { 0x8064, 0x00000020 }, /* NVDLA_SDP_RDMA_D_EW_LINE_STRIDE_0 */
    { 0x803c, 0x355eb1e0 }, /* NVDLA_SDP_RDMA_D_BS_BATCH_STRIDE_0 */
...
int main(int argc, char* argv[])
{
    ...
    { /* CRC[0]: addr=0xd00001c0, size=0xf00, expect=0xbd5bd3c2 */
        uint8_t* page = (uint8_t*)mmap(NULL, 8192, PROT_READ, MAP_SHARED, fd, 0xd0000000);
        if (page != MAP_FAILED) {
            uint32_t crc = calc_crc32(page + 448, 3840);
            printf("CRC[0] = 0x%08x (expect 0xbd5bd3c2) %s\n", crc, crc == 0xbd5bd3c2 ? "PASS" : "FAIL");
            if (crc != 0xbd5bd3c2) failures++;
            munmap(page, 8192);
