...
Build test case
```bash
cd ref/vp/tests/nv_small_tests/dc_1x1x8_1x1x8x1_int8_0

# Parse .cfg + .dat files and generate a self-contained C test binary.
# The generated binary embeds .dat payloads and loads them via /dev/mem mmap.
# *_load.sh devmem scripts are legacy/optional.
